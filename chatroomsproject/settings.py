...
SECRET_KEY = 'jroegjresolk3ogrjgorejgrelgfsdglkjgoras'
# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
#CSRF_COOKIE_SECURE = True
#SESSION_COOKIE_SECURE = True

#ALLOWED_HOSTS = ['localhost', '.pythonanywhere.com', 'HibikiWakano.pythonanywhere.com']
ALLOWED_HOSTS = []
...
ROOT_URLCONF = 'chatroomsproject.urls'
...
WSGI_APPLICATION = 'chatroomsproject.wsgi.application'
