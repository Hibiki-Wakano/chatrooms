...
urlpatterns = [
    ...
    path('user/<int:pk>/update', views.UserUpdateView.as_view(), name='uu'),
    path('user/<int:pk>/delete', views.UserDeleteView.as_view(), name='udl'),
    ...
    path('room/<int:pk>/update', views.RoomUpdateView.as_view(), name='ru'),
    path('room/<int:pk>/delete', views.RoomDeleteView.as_view(), name='rdl'),
